...
class WirelessChannel: public CastaliaModule {
 private:
	...
	// Parameters for wireless underground communications
	double alpha; // real part of the complex propagation constant
	double beta;  // imaginary part of the complex propagation constant
